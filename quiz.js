...
function writeQuestionArray(){
  indexOfQuestions = 0;
    ...
    questionArray = [/*html*/`
      ...
      <img class="question-img" src="images/stejkova reakce/co se vezlo.jpg">
      <div class="answer">
        <div class="doplnovacka">
          Vezlo se
          <select class="selection">
            <option value="false">...</option>
            <option value="false">kříže</option>
            <option value="false">bible</option>
            <option value="true">jídlo</option>
          </select>
          .
        </div>
      </div>
      <div class="vyhodnoceni-container">
        ...
        <button class="js-button-incorrect">Nevím</button>
            ...
            <p class="question">
        Kolik jídla se vezlo v tomto veledíle?
      </p>
      <img class="question-img" src="images/jídelní expres/kolik kusů se.PNG">
      <div class="answer">
        <div class="doplnovacka">
          Vezly se
          <select class="selection">
      ...
      <div class="vyhodnoceni-container">
        ...
        Kdo je autorem tohoto filmečku?
      </p>
      <img class="question-img" src="images/jídelní expres/kdo je autorem.jpg">
      <div class="answer">
        <div class="doplnovacka">
          Autorem tohoto veledíla je
          <select class="selection">
            <option value="false">...</option>
      ...
      <img class="question-img" src="images/jídelní expres/kam se zboží.jpg">
      <div class="answer">
        <div class="doplnovacka">
          Žádané zboží se vezlo do
          <select class="selection">
            <option value="false">...</option>
            <option value="false">Muzea</option>
            <option value="true">Restaurace</option>
            <option value="false">Supermartketu</option>
          </select>
          .
        </div>
      </div>
      ...
      `, `<p class="question">
        Nabízel jim někdo jídlo?
      </p>
      <img class="question-img" src="images/jídelní expres/nabízelů jim někdo.jpg">
      <div class="answer">
        <div class="doplnovacka">
          <select class="selection">
            <option value="false">...</option>
      ...
      <img class="question-img" src="images/jídelní expres/co skákalo.jfif">
      <div class="answer">
        <div class="doplnovacka">
          Po skle skákalo
          <select class="selection">
            <option value="false">...</option>
            <option value="false">Potvora</option>
            <option value="true">Žabák</option>
            <option value="false">Pes</option>
          </select>
          .
        </div>
      </div>
    ...
    questionArray = [/*html*/`
      ...
      <img class="question-img" src="images/stejkova reakce/co delal kejda se .jpg">
      <div class="answer">
        <div class="doplnovacka">
      ...
      <div class="vyhodnoceni-container">
        ...
        Co jedl zelenáč, když měl hlad?
      </p>
      <img class="question-img" src="images/stejkova reakce/co jedl zelenáč.jfif">
      <div class="answer">
        <div class="doplnovacka">
          Zelenáč jedl 
          <select class="selection">
            <option value="false">...</option>
            <option value="true">fazole</option>
            <option value="false">čočku</option>
            <option value="false">guláš</option>
          </select>
          .
        </div>
      </div>
      <div class="vyhodnoceni-container">
        ...
        Na jakou pohádku se díval červenáč?
      </p>
      <img class="question-img" src="images/stejkova reakce/na jakou pohádku secdíval červenáč.jpg">
      <div class="answer">
        <div class="doplnovacka">
          Červenáč se díval na
          <select class="selection">
            <option value="false">...</option>
            <option value="false">debatu</option>
            <option value="false">jídelní expres</option>
            <option value="true">pepu pig</option>
          </select>
          .
        </div>
      </div>
      <div class="vyhodnoceni-container">
        ...
        Splnili tu svou hloupou challenge?
      </p>
      <img class="question-img" src="images/stejkova reakce/splnili tu svou hloupou challenge.jfif">
      <div class="answer">
        <div class="doplnovacka">
          <select class="selection">
            <option value="false">...</option>
      ...
      <div class="vyhodnoceni-container">
        ...
        Kdo je autorem filmečku?
      </p>
      <img class="question-img" src="images/stejkova reakce/kdo je autorem.jfif">
      <div class="answer">
        <div class="doplnovacka">
          Autorem filmečku je
          <select class="selection">
